...
<div class="py-12">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white p-8 shadow-xl rounded-2xl transform transition-all hover:shadow-2xl relative">
            ...
            <h3 class="text-2xl font-bold text-blue-600 mb-4">{{ $restaurant->name }}</h3>
            ...
            @if($restaurant->opening_hours)
                <div class="mb-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        @php
                            $hours = is_string($restaurant->opening_hours) ? json_decode($restaurant->opening_hours, true) : $restaurant->opening_hours;
