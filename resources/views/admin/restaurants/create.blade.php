...
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.restaurants.index') }}" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-md text-sm">
                Back to Hotels
            </a>
        </div>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('admin.restaurants.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <div class="flex items-center">
                                ...
                                <label for="is_featured" class="ml-2 text-sm text-gray-600">Feature this restaurant on homepage</label>
                            </div>
